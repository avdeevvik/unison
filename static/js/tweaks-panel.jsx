...
// In Unison Django build the host-protocol side is dormant: the panel only
// activates if the page is loaded inside the design tool. In production it
// just exports useTweaks/TweaksPanel/Tweak* helpers used by app.jsx.
      ...
      <div className="twk-chips">
        {options.map((c) => (
          <button key={c} type="button" className="twk-chip"
                  data-on={c.toLowerCase() === String(value).toLowerCase() ? '1' : '0'}
...
Object.assign(window, {
  ...
  TweakToggle, TweakRadio, TweakColor, TweakButton,
});
